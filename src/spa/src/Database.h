...
public:
	...
	static void insertProcedure(string procedureName, string isRead=NULL, string isPrint=NULL, string isAssign=NULL, string variable=NULL, string constant=NULL);

	// method to get all the procedures from the database
	static void getSelectResult(vector<string>& results, string type);
